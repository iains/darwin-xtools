...
{
	return this->alignedSize(16 + PPC_TGT_THREAD_STATE_COUNT * 4);	// base size + PPC_THREAD_STATE_COUNT * 4
}
...
uint8_t* HeaderAndLoadCommandsAtom<ppc>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_count(PPC_TGT_THREAD_STATE_COUNT);		// PPC_THREAD_STATE_COUNT;
...
{
	return this->alignedSize(16 + PPC_TGT_THREAD_STATE64_COUNT * 4);	// base size + PPC_THREAD_STATE64_COUNT * 4
}
...
uint8_t* HeaderAndLoadCommandsAtom<ppc64>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_count(PPC_TGT_THREAD_STATE64_COUNT);	// PPC_THREAD_STATE64_COUNT 76;
	cmd->set_thread_register(0, start);
...
{
	return this->alignedSize(16 + i386_TGT_THREAD_STATE_COUNT * 4);	// base size + i386_THREAD_STATE_COUNT * 4
}
...
uint8_t* HeaderAndLoadCommandsAtom<x86>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_count(i386_TGT_THREAD_STATE_COUNT);   // i386_THREAD_STATE_COUNT;
...
{
	return this->alignedSize(16 + x86_TGT_THREAD_STATE64_COUNT * 4); 
}
...
uint8_t* HeaderAndLoadCommandsAtom<x86_64>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_count(x86_TGT_THREAD_STATE64_COUNT);
...
{
	return this->alignedSize(16 + ARM_TGT_THREAD_STATE_COUNT * 4); // base size + ARM_THREAD_STATE_COUNT * 4
}
...
uint8_t* HeaderAndLoadCommandsAtom<arm>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_count(ARM_TGT_THREAD_STATE_COUNT);
...
{
	return this->alignedSize(16 + ARM_TGT_THREAD_STATE64_COUNT * 8); // base size + ARM_TGT_THREAD_STATE64_COUNT * 4
}
...
uint8_t* HeaderAndLoadCommandsAtom<arm64>::copyThreadsLoadCommand(uint8_t* p) const
{
	...
	cmd->set_cmd(LC_UNIXTHREAD);
	cmd->set_cmdsize(threadLoadCommandSize());
	cmd->set_flavor(ARM_THREAD_STATE64);	 // ARM_THREAD_STATE64
	cmd->set_count(ARM_TGT_THREAD_STATE64_COUNT);	 // ARM_TGT_THREAD_STATE64_COUNT
